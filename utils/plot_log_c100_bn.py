...
nameoend = 'isonext_train_cifar100_2gpu_BN'
bnfile = open(f"./logs/{nameoend}.txt", 'r')
bnaccuracy = []
bnepochs = []
bnloss = []
for line in bnfile:
...
onameoend = 'isonext_train_cifar100_2gpu'
obnfile = open(f"./logs/{onameoend}.txt", 'r')
obnaccuracy = []
obnepochs = []
obnloss = []
for line in obnfile:
...
obnaccuracy = [i+0.07 for i in obnaccuracy]
